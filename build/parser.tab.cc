...
#line 82 "/home/jschuetzle/school/compilers/SchemeCompiler/build/parser.tab.cc"
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_REAL_TYPE = 6,                  /* REAL_TYPE  */
  YYSYMBOL_STRING_TYPE = 7,                /* STRING_TYPE  */
  YYSYMBOL_BOOL_TYPE = 8,                  /* BOOL_TYPE  */
  YYSYMBOL_LIST_TYPE = 9,                  /* LIST_TYPE  */
  YYSYMBOL_APOSTROPHE = 10,                /* APOSTROPHE  */
  YYSYMBOL_BOOL_LITERAL = 11,              /* BOOL_LITERAL  */
  YYSYMBOL_INT_LITERAL = 12,               /* INT_LITERAL  */
  YYSYMBOL_REAL_LITERAL = 13,              /* REAL_LITERAL  */
  YYSYMBOL_ID = 14,                        /* ID  */
  YYSYMBOL_RELOP_GT = 15,                  /* RELOP_GT  */
  YYSYMBOL_RELOP_LT = 16,                  /* RELOP_LT  */
  YYSYMBOL_RELOP_GE = 17,                  /* RELOP_GE  */
  YYSYMBOL_RELOP_LE = 18,                  /* RELOP_LE  */
  YYSYMBOL_RELOP_EQ = 19,                  /* RELOP_EQ  */
  YYSYMBOL_ARITH_PLUS = 20,                /* ARITH_PLUS  */
  YYSYMBOL_ARITH_MINUS = 21,               /* ARITH_MINUS  */
  YYSYMBOL_ARITH_MULT = 22,                /* ARITH_MULT  */
  YYSYMBOL_ARITH_DIV = 23,                 /* ARITH_DIV  */
  YYSYMBOL_ARITH_REMAINDER = 24,           /* ARITH_REMAINDER  */
  YYSYMBOL_NULL_CHECK_OP = 25,             /* NULL_CHECK_OP  */
  YYSYMBOL_BOOL_CHECK_OP = 26,             /* BOOL_CHECK_OP  */
  YYSYMBOL_NUMBER_CHECK_OP = 27,           /* NUMBER_CHECK_OP  */
  YYSYMBOL_REAL_CHECK_OP = 28,             /* REAL_CHECK_OP  */
  YYSYMBOL_LIST_CHECK_OP = 29,             /* LIST_CHECK_OP  */
  ...
  YYSYMBOL_globalDefList = 45,             /* globalDefList  */
  YYSYMBOL_exprList = 46,                  /* exprList  */
  YYSYMBOL_type = 47,                      /* type  */
  YYSYMBOL_expr = 48,                      /* expr  */
  YYSYMBOL_paramList = 49,                 /* paramList  */
  YYSYMBOL_datum = 50,                     /* datum  */
  YYSYMBOL_intLit = 51,                    /* intLit  */
  YYSYMBOL_realLit = 52                    /* realLit  */
};
...
static const char *const yytname[] =
{
  ...
  "INT_TYPE", "REAL_TYPE", "STRING_TYPE", "BOOL_TYPE", "LIST_TYPE",
  "APOSTROPHE", "BOOL_LITERAL", "INT_LITERAL", "REAL_LITERAL", "ID",
  "RELOP_GT", "RELOP_LT", "RELOP_GE", "RELOP_LE", "RELOP_EQ", "ARITH_PLUS",
  "ARITH_MINUS", "ARITH_MULT", "ARITH_DIV", "ARITH_REMAINDER",
  "NULL_CHECK_OP", "BOOL_CHECK_OP", "NUMBER_CHECK_OP", "REAL_CHECK_OP",
  "LIST_CHECK_OP", "LOGICAL_OR", "LOGICAL_AND", "LOGICAL_NOT", "DEFINE",
  "LET", "CAR", "CDR", "CONS", "LAMBDA", "COND", "IF", "ELSE",
  "STRING_LITERAL", "$accept", "program", "globalDefList", "exprList",
  "type", "expr", "paramList", "datum", "intLit", "realLit", YY_NULLPTR
};
...
{
     -32,    16,    -3,   -32,   -31,   -32,   -32,   -32,    -7,   -32,
       0,   -32,   -32,   -32,     3,    23,   -32,   -32,   -18,   -32,
       0,   -32,   -32,   -32,   -32,    17,    31,    15,    23,   -32,
     -32,    20,    18,   -32,     0,    22,    33,   -32,   -32
};
...
{
       3,     0,     5,     1,     0,    19,    21,    18,     0,     2,
       5,    12,    16,    17,     0,     0,    20,    22,     0,     6,
       0,     8,     9,    10,     7,     0,     0,     0,     0,    14,
       4,     0,     0,    11,     0,     0,     0,    15,    13
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -32,   -32,   -32,    28,   -24,   -19,   -32,   -32,   -32,   -32
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     1,     2,     9,    26,    10,    32,    11,    12,    13
};
...
{
       4,    27,    14,    18,    31,    16,    17,    15,    35,     5,
       6,     7,     5,     6,     7,    36,     3,    20,     8,    30,
      15,     8,    34,    21,    22,    23,    24,    25,    21,    22,
      23,    24,    25,    28,    29,    33,    37,    38,    19
};

static const yytype_int8 yycheck[] =
{
       3,    20,    33,     3,    28,    12,    13,    38,    32,    12,
      13,    14,    12,    13,    14,    34,     0,    14,    21,     4,
      38,    21,     4,     5,     6,     7,     8,     9,     5,     6,
       7,     8,     9,    16,     3,    15,    14,     4,    10
};
...
{
       0,    44,    45,     0,     3,    12,    13,    14,    21,    46,
      48,    50,    51,    52,    33,    38,    12,    13,     3,    46,
      14,     5,     6,     7,     8,     9,    47,    48,    16,     3,
       4,    47,    49,    15,     4,    47,    48,    14,     4
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* globalDefList: globalDefList LPAREN DEFINE ID expr RPAREN  */
#line 88 "src/frontend/parser.y"
    ...
    auto v = ast.AddGlobalVariable((yyvsp[-2].strval), std::unique_ptr<ASTExpression>((yyvsp[-1].exp)));
